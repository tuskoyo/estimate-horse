...
img_dir = "/home/osamu/horse_data/uma"
output_dir = "/home/osamu/horse_data/uma_out"
...
for img_name in os.listdir(img_dir):
    ...
    position_df.loc[frame_idx] = [img_name] + position_data
...
position_df.to_csv(os.path.join(img_dir,'position.csv'), index=False)
